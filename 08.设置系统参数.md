...
![系统默认账户](img/p08/system_default_user.jpeg)
...
![创建新管理员账户](img/p08/new_system_user.jpeg)

设置完成后，如图所示。  

![新管理员账户创建完成](img/p08/new_admin_user_done.jpeg)

登出 Winbox，并用 **新创建的** 管理员账户进行登录，以确保新管理员账户可正常使用。  

鼠标 **双击** 管理员 `admin` 条目，修改其权限和可访问来源地址。  

![修改老系统账户](img/p08/modify_old_admin.jpeg)

修改完成后，如图所示。  

![系统账户修改完成](img/p08/all_system_user_done.jpeg)
...
![格式化硬盘](img/p08/wb_format_disk.jpeg)

等待硬盘格式化完成后，即可使用该硬盘用于记录离线日志。  

![格式化硬盘完成](img/p08/wb_format_disk_done.jpeg)
...
![日志操作细节](img/p08/wb_add_log_action_details.jpeg)
...
![浏览日志文件](img/p08/wb_log_files.jpeg)
...
![系统备份](img/p08/system_backup.jpeg)

备份完成后，如图所示。  

![系统备份完成](img/p08/system_backup_done.jpeg)
