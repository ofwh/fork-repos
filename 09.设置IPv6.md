...
如果按照之前的文章 [08.设置系统参数.md](08.设置系统参数.md) 关闭了 IPv6 ，此时需要将其重新打开。  
...
|PPPoE|是|高级|[ros_firewall_ipv6_pppoe_dns.conf](./src/firewall/ros_firewall_ipv6_pppoe_dns.conf)|
|PPPoE|否|精简|[ros_firewall_ipv6_pppoe_simple.conf](./src/firewall/ros_firewall_ipv6_pppoe_simple.conf)|
...
如果这段代码不好复制，请查阅文件 [ros_blackhole_ipv6.conf](./src/firewall/ros_blackhole_ipv6.conf) 进行复制。  
