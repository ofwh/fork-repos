...
|参数|值|说明|
|--|--|--|
|Valid Lifetime|`01:00:00`|IPv6 地址最大生存周期|
|Preferred Lifetime|`00:30:00`|IPv6 地址建议生存周期|
...
由于 IPv6 防火墙的配置命令很长，因此请查阅文件 [fox_ros_firewall_ipv6.conf](./src/firewall/fox_ros_firewall_ipv6.conf) 进行复制。  
...
![检查IPv6地址](img/p9/ipv6_address_check.png)
