...
|名称|开始时间|执行周期|说明|
|--|--|--|--|
|system_log_timer|00:00:00|40m|系统日志触发器|
|system_res_timer|00:05:00|6h|系统资源触发器|
|system_upgrade_timer|02:35:00|1d|系统更新触发器|
|disable_pppoe_timer|04:00:00|1d|断连 PPPoE|
|enable_pppoe_timer|04:00:10|1d|重连 PPPoE|
