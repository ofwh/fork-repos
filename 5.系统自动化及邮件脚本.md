...
add comment="pppoeconf: system disable PPPoE" interval=2d name=disable_pppoe_timer on-event="/interface disable pppoe-out1" policy=write start-time=04:00:00
add comment="pppoeconf: system enable PPPoE" interval=2d name=enable_pppoe_timer on-event="/interface enable pppoe-out1" policy=write start-time=04:00:10
...
|disable_pppoe_timer|04:00:00|2d|每2天执行一次断连 PPPoE|
|enable_pppoe_timer|04:00:10|2d|每2天执行一次重连 PPPoE|
