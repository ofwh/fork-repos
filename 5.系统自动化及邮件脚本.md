...
- 对于使用 CHR 版本 RouterOS 的软路由
    - 自动更新脚本，请查阅 [Fox_ROS_CHR_Sys_Upgrade_Worker.conf](./src/Fox_ROS_CHR_Sys_Upgrade_Worker.conf)
...
- 对于使用 Mikrotik 原生 RouterOS 的硬路由
    - 自动更新脚本，请查阅 [Fox_ROS_Native_Sys_Upgrade_Worker.conf](./src/Fox_ROS_Native_Sys_Upgrade_Worker.conf) 
    - 系统日志邮件脚本，与 CHR 版本相同
    - 系统资源邮件脚本，与 CHR 版本略有不同，请参考 [Fox_ROS_RB750Gr3_Email_Res_Worker.conf](./src/Fox_ROS_RB750Gr3_Email_Res_Worker.conf)
