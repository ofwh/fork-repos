...
如果不便复制代码，请查阅文件 [ros_define_interfaces_pppoe.conf](./src/interfaces/ros_define_interfaces_pppoe.conf) 。  
...
如果不便复制代码，请查阅文件 [ros_define_interfaces_dhcp.conf](./src/interfaces/ros_define_interfaces_dhcp.conf) 。  
...
/interface list member
add list=WAN comment="defconf: extranet member" interface=ether1
add list=LAN comment="defconf: intranet member" interface=bridge1
```
