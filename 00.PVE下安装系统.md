...
## 下载 RouterOS 镜像文件
$ curl -LR -O https://download.mikrotik.com/routeros/7.17/chr-7.17.img.zip
```
...
## 计算文件 hash
$ sha256sum chr-7.17.img.zip

#### 文件 hash 示例输出
a47b84a4541265c1598daf7cea8c6cdc668ac5dd43e2a160844d7b0d7b432142  chr-7.17.img.zip
```
...
```bash
## 将 img 镜像导入虚拟机中
$ qm importdisk 101 chr-7.17.img local-lvm
