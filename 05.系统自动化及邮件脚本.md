...
如果需要禁用某个定时器，使用鼠标 **单击** 选中定时器，点击 `Disable` 进行禁用：

![停用某定时器](img/p05/wb_scheduler_disable.png)
...
![系统日志邮件脚本](img/p05/email_log_script.png)
...
![系统资源邮件脚本](img/p05/email_res_script.png)
