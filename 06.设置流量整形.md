...
```bash
/queue type
add name=cake-rx kind=cake cake-diffserv=diffserv4 cake-flowmode=dual-dsthost cake-rtt=45ms cake-overhead-scheme=ethernet cake-nat=yes
add name=cake-tx kind=cake cake-diffserv=diffserv4 cake-flowmode=dual-srchost cake-rtt=45ms cake-overhead-scheme=ethernet cake-nat=yes cake-ack-filter=filter
...
```bash
/queue type
add name=cake-rx kind=cake cake-diffserv=diffserv4 cake-flowmode=triple-isolate cake-rtt=10ms cake-overhead-scheme=ethernet cake-nat=no
add name=cake-tx kind=cake cake-diffserv=diffserv4 cake-flowmode=triple-isolate cake-rtt=45ms cake-overhead-scheme=ethernet cake-nat=yes cake-ack-filter=filter
...
```bash
/queue type
add name=fq-codel-rx kind=fq-codel fq-codel-limit=1024 fq-codel-quantum=512
add name=fq-codel-tx kind=fq-codel fq-codel-limit=768 fq-codel-quantum=384
