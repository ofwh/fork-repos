...
```bash
/queue type
add name=fq-codel-rx kind=fq-codel fq-codel-memlimit=16.0MiB fq-codel-interval=80ms fq-codel-target=4ms
add name=fq-codel-tx kind=fq-codel fq-codel-memlimit=16.0MiB fq-codel-interval=80ms fq-codel-target=4ms
...
```bash
/queue type
add name=fq-codel-interface kind=fq-codel fq-codel-memlimit=16.0MiB
...
```bash
/queue type
add name=fq-codel-interface kind=fq-codel fq-codel-memlimit=16.0MiB fq-codel-quantum=768 fq-codel-interval=80ms fq-codel-target=4ms
